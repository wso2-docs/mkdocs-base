...
![](attachments/92522902/92522903.png){width="750"}
...
![](attachments/92522902/92522904.png)
...
![](attachments/92522902/92522905.png)
...
to read about the history of identity provisioning.
...
![](attachments/92522902/92522906.png){width="750"}
...
[SPML
1.0](https://www.oasis-open.org/committees/download.php/3032/cs-pstc-spml-core-1.0.pdf) defined
a Request/Response protocol as well as couple of bindings.
Requests/Responses are all based on XML and each operation has it own
schema.

One of
the [bindings](http://xml.coverpages.org/SPML-Bindings10-OS.pdf) defined
in SPML 1.0 is the SOAP binding. It specifies how to transfer SPML
requests and responses wrapped in a SOAP message. All the SPML
...
finalized in 2012 - and then it was donated to
the [IETF](http://tools.ietf.org/wg/scim/). Once in IETF, it changed the
...
working on a REST binding for SPML, which is known
as [RESTPML](https://wiki.oasis-open.org/provision/restpml), around
2011. This is still based on XML and not yet active so far.

## Attachments:

![](images/icons/bullet_blue.gif){width="8" height="8"} [image2017-3-31
14:5:18.png](attachments/92522902/92522903.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [image2017-4-3
12:44:11.png](attachments/92522902/92522904.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [image2017-4-3
12:47:23.png](attachments/92522902/92522905.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[SCIM\_History.png](attachments/92522902/92522906.png) (image/png)  
