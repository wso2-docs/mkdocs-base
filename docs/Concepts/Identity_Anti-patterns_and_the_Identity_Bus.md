...
According to research conducted by the analyst
firm, [Quocirca](http://quocirca.com/), many businesses now have more
...
![](attachments/92522888/92522889.png){height="250"}
...
![](attachments/92522888/92522891.png){width="350"}
...
3.  **Enforcing new authentication protocols is extremely
    easy.** Consider a scenario where you need to authenticate users
    with both the username and password and also Duo Security (SMS based
...
4.  **Claim transformations.** Your service provider may read user's
    email address from the "http://sp1.org/claims/email" attribute id -
    but the identity provider of the user may send it as
    "http://idp1.org/claims/emai". Identity bus can transform the claims
    it receives from the identity provider to the format expected by the
    service provider.
...
[image2017-11-30\_17-30-33.png](attachments/92522888/92522889.png)
(image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[image2017-11-30\_17-29-58.png](attachments/92522888/92522890.png)
(image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [image2015-3-19
15:29:0.png](attachments/92522888/92522891.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [image2015-3-19
15:13:16.png](attachments/92522888/92522892.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [image2015-3-19
14:59:29.png](attachments/92522888/92522893.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [image2015-3-19
14:14:0.png](attachments/92522888/92522894.png) (image/png)  
